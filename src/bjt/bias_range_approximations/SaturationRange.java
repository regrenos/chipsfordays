...
public class SaturationRange {
	...
	public static double baseCurrent(double vBE, double vBC, double betaF,
		...
		return BipolarJunctionTransistor
				.baseCurrent(vBE, vBC, betaF, betaR, iS);
	}
	 ...
	 */
	public static double baseEmitterSaturationBias(double iS, double iB,
			double iC, double alphaR, double betaF) {
		return Constants.kbtq
				* Math.log((iB + (1 - alphaR) * iC)
						/ (iS * (1 / betaF + 1 - alphaR)));
	}
	 ...
	 */
	public static double baseCollectorSaturationBias(double iS, double iB,
			double iC, double alphaR, double betaF) {
		return Constants.kbtq
				* Math.log((iB - iC / betaF)
						/ ((iS / alphaR) * (1 / betaF + 1 - alphaR)));
	}
	 ...
	 */
	public static double collectorEmitterSaturationBias(double iB, double iC,
			double alphaR, double betaF) {
		return Constants.kbtq
				* Math.log((iB + (1 - alphaR) * iC)
						/ (alphaR * (iB - iC / betaF)));
	}
