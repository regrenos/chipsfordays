...
public class MOSCAP {
	...
	/**
	 * Contact-Potential Different Between the P-type Substrate and the Backside
	 * Metal Contact (V)
	 */
	...
	public static double Vtn(double Na, double QfQit, double Xox) {
		double a = Vfb(Na, Xox, QfQit) + 2 * phiFb(Na)
				+ Math.sqrt(4 * Constants.q * Constants.esi * Na * phiFb(Na))
				/ Cox(Xox);
